// creating weekly receiving yards char
...
function renderAxes(newYScale, yAxis) {
  ...
  // load data from json 
d3.csv("data/reg_pbp_2019.csv").then(function(chiefsData, err) {
    if (err) throw err;
    // print chiefs data
  ...
  labelsGroup.selectAll("text")
    .on("click", function() {
      ...
      if (value !== chosenYAxis) {
        ...
        yaxis = renderAxes(yLinearScale, yaxis);        // updates circles with new y values
